...
function Controller() {
    ...
    function hideKeyboard(e) {
        ...
        e.source.id != $.phoneUser.id && $.phoneUser.blur();
        ...
        geo.checkLocation(function() {
            ...
            geo.reverseGeocoding(geo.location.latitude, geo.location.longitude, function(e) {
                ...
                if (e.error) Alloy.Globals.core.showErrorDialog(e.message ? L(e.message) : L(e.error)); else if (e && e.response) {
                    e.response.results && e.response.results[0] && e.response.results[0].formatted_address ? element.value = e.response.results[0].formatted_address : e.response.resourceSets && e.response.resourceSets[0] && e.response.resourceSets[0].resources && e.response.resourceSets[0].resources[0] && e.response.resourceSets[0].resources[0].address && e.response.resourceSets[0].resources[0].address.formattedAddress && (element.value = e.response.resourceSets[0].resources[0].address.formattedAddress);
    ...
    $.__views.phoneUserLbl = Ti.UI.createLabel({
        width: Alloy.Globals.Styles.labelWidth,
        height: Alloy.Globals.Styles.labelHeight,
        color: Alloy.Globals.Styles.labelColor,
        left: Alloy.Globals.Styles.labelLeft,
    ...
    $.__views.__alloyId122.add($.__views.phoneUserLbl);
    $.__views.phoneUser = Ti.UI.createTextField({
        width: Alloy.Globals.Styles.inputWidth,
        height: Alloy.Globals.Styles.inputHeight,
        top: Alloy.Globals.Styles.inputUp,
        bottom: "10dp",
    ...
    $.__views.__alloyId122.add($.__views.phoneUser);
    focus ? $.__views.phoneUser.addEventListener("focus", focus) : __defers["$.__views.phoneUser!focus!focus"] = true;
    ...
    __defers["$.__views.phoneUser!focus!focus"] && $.__views.phoneUser.addEventListener("focus", focus);

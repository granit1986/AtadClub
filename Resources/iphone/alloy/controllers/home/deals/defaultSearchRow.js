...
function Controller() {
    ...
    this.__controllerPath = "home/deals/defaultSearchRow";
    if (arguments[0]) {
        {
    ...
    $.__views.rowWrap.add($.__views.__alloyId233);
    $.__views.statusLbl = Ti.UI.createLabel({
        id: "statusLbl",
        visible: "false"
    });
    $.__views.__alloyId233.add($.__views.statusLbl);
    $.__views.raitingLbl = Ti.UI.createLabel({
        id: "raitingLbl",
        visible: "false"
    });
    $.__views.__alloyId233.add($.__views.raitingLbl);
    ...
    $.__views.dealInfoWrap.add($.__views.__alloyId234);
    ...
    $.__views.__alloyId234.add($.__views.titleLbl);
    $.__views.__alloyId235 = Ti.UI.createView({
        layout: "absolute",
        height: "30dp",
        id: "__alloyId235"
    });
    $.__views.dealInfoWrap.add($.__views.__alloyId235);
    ...
    $.__views.__alloyId235.add($.__views.companyLbl);
    ...
    $.__views.__alloyId235.add($.__views.dealTypeLbl);
    $.__views.__alloyId236 = Ti.UI.createView({
        layout: "absolute",
        height: "30dp",
        id: "__alloyId236"
    });
    $.__views.dealInfoWrap.add($.__views.__alloyId236);
    ...
    $.__views.__alloyId236.add($.__views.distanceLbl);
    ...
    $.__views.__alloyId236.add($.__views.distanceVal);
    ...
    $.__views.__alloyId236.add($.__views.priceLbl);
    ...
    $.__views.dealInfoWrap.add($.__views.__alloyId237);
    ...
    $.__views.__alloyId237.add($.__views.endTimeLbl);
    $.__views.endTimeVal = Ti.UI.createLabel({
        height: "20dp",
        top: "10dp",
        left: Alloy.Globals.Styles.endTimeVal_left,
        right: Alloy.Globals.Styles.endTimeVal_right,
        font: {
            fontSize: "12dp",
            fontFamily: "Avenir Next Condensed"
        },
    ...
    $.__views.__alloyId237.add($.__views.endTimeVal);

...
module.exports = [ {
    ...
    isApi: true,
    queries: {
        "if": "Alloy.Globals.isHe"
    },
    priority: 1501.9005000000002,
    key: "TextArea",
    style: {
        textAlign: "right"
    }
    ...
    isClass: true,
    priority: 10000.9017,
    key: "formLongLabelForSwitch",
    style: {
        width: "230dp",
        height: Alloy.Globals.Styles.labelHeight,
        color: Alloy.Globals.Styles.labelColor,
        left: Alloy.Globals.Styles.labelLongLeft,
        right: Alloy.Globals.Styles.labelLongRight,
        textAlign: Alloy.Globals.Styles.labelTextAlign,
        font: {
            fontSize: "15dp",
            fontFamily: "Avenir Next Condensed"
    ...
    isClass: true,
    priority: 10000.9049,
    key: "smallHorButton_align",
    style: {
        left: Alloy.Globals.Styles.smallHorButton_Left,
        right: Alloy.Globals.Styles.smallHorButton_Left
    }
}, {
    isClass: true,
    priority: 10000.904999999999,
    key: "modalPickerBlock",
    style: {
        layout: "vertical",
        width: Ti.UI.FILL,
        height: Ti.UI.SIZE,

...
// in simulator we redefine to format for AtadClub Developer console
...
{\
	NSString * exceptionName = [@"org.atadclub." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.atadclub";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIAtadClubNativeItemNone = -1, 
	UIAtadClubNativeItemSpinner = -2,
	UIAtadClubNativeItemProgressBar = -3,
	
	UIAtadClubNativeItemSlider = -4,
	UIAtadClubNativeItemSwitch = -5,
	UIAtadClubNativeItemMultiButton = -6,
	UIAtadClubNativeItemSegmented = -7,
	
	UIAtadClubNativeItemTextView = -8,
	UIAtadClubNativeItemTextField = -9,
	UIAtadClubNativeItemSearchBar = -10,
	
	UIAtadClubNativeItemPicker = -11,
	UIAtadClubNativeItemDatePicker = -12,
	
	UIAtadClubNativeItemInfoLight = -13,
	UIAtadClubNativeItemInfoDark = -14,
	
	UIAtadClubNativeItemDisclosure = -15,
	
	UIAtadClubNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all AtadClub instances of

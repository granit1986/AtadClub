...
//@interface AtadClubObject : NSObject
//@end

@interface AtadClubObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[AtadClubObject class]])
		{
			for (NSString *key in [[(AtadClubObject*)o modules] allKeys])
			{
